...
def double_pinhole_interference(x, gamma, I1, I2, d, w1,w2 = None, x0 = None, wav = 1000*e2wav(9.3), z = 1, norm = 1):
    """ 
...
def fix_experimental_params(wav = 1000*e2wav(9.3), z = 3.5, norm = 1, x0 = 0):
    """
